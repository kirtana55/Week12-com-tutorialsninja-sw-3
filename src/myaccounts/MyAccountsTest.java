...
//        3.3 Enter First Name
        sendTextToElement(By.xpath("//input[@id='input-firstname']"),"Raju");
//        3.4 Enter Last Name
        sendTextToElement(By.xpath("//input[@id='input-lastname']"),"Japan");
//        3.5 Enter Email
        sendTextToElement(By.xpath("//input[@id='input-email']"),"qwerty1@gmail.com");
//        3.6 Enter Telephone
